...
# --- EJEMPLO PARA MOSTRAR EN PANTALLA ---
formulario = Formulario()

# 1. Datos con errores (email mal y contraseña corta)
datos_mal = {
    "nombre": "Samuel",
    "email": "samuel.com", # Mal formato
    "contraseña": "123",    # Muy corta y sin mayúsculas
    "edad": 15              # Menor de edad
}

print("--- Validando datos incorrectos ---")
if not formulario.validar(datos_mal):
    print("Errores encontrados:")
    for campo, mensaje in formulario.obtener_errores().items():
        print(f"- {campo.capitalize()}: {mensaje}")

# 2. Datos correctos
datos_bien = {
    "nombre": "Samuel Moreno",
    "email": "samuel@correo.com",
    "contraseña": "Password123",
    "edad": 20
}

print("\n--- Validando datos correctos ---")
if formulario.validar(datos_bien):
    print("Formulario válido, listo para enviar al Backend.")                