class CuentaBancaria:
    def __init__(self, titular, saldo_inicial=0.0):
        ...
        # Validamos el saldo inicial antes de asignarlo
        if saldo_inicial < 0:
            raise ValueError("El saldo no puede ser negativo")
        self._saldo = float(saldo_inicial)

    # Propiedad titular: Solo lectura (no tiene setter)
    @property
    def titular(self):
        return self._titular

    # Propiedad saldo: Lectura y modificación controlada
    @property
    def saldo(self):
        return self._saldo
...
# --- PRUEBA PARA VALIDAR EL FUNCIONAMIENTO DE LA CLASE ---
if __name__ == "__main__":
    try:
        # Inicialización con titular y saldo (por defecto 0 si no se pone)
        cuenta = CuentaBancaria("Samuel Moreno", 1000)
        ...
        # Prueba de restricción: Saldo negativo (Esto lanzará el ValueError)
